...
/*
        ...
        boolean tru = Search.linearSearch2(38, numArray);
        System.out.println(tru);
        tru  = Search.linearSearch2(9, numArray);
        System.out.println(tru);
        tru = Search.linearSearch2(5, numArray);
        System.out.println(tru);
